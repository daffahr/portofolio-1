...
class Venom2 extends StatelessWidget {
  const Venom2({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage("assets/pict/Pict-Venom2.png"),
          fit: BoxFit.cover,
        ),
      ),
    );
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const Text(
            "Venom returns to action when serial killer Cletus Kasady transforms into the villainous Carnage.",
            style: TextStyle(
              fontSize: 17,
          ...
          Row(
            ...
            children: const [
              Text(
                "Tom Hardy | Woody Harrelson | Michelle...",
                style: TextStyle(
                  fontSize: 17,
                  fontWeight: FontWeight.w400,
                  color: Colors.white,
