...
class Mulan extends StatelessWidget {
  const Mulan({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage("assets/pict/Pict-Mulan.png"),
          fit: BoxFit.cover,
        ),
      ),
    );
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const Text(
            "When the emperor of China issues a decree that one man per family must join the imperial army to defend the country against the Huns, Hua Mulan, the eldest daughter of an...",
            style: TextStyle(
              fontSize: 17,
          ...
          Row(
            ...
            children: const [
              Text(
                "Liu Yifei | Jet Li | Donnie Yen | Gong Li",
                style: TextStyle(
                  fontSize: 17,
                  fontWeight: FontWeight.w400,
                  color: Colors.white,
