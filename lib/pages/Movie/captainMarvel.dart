...
class CaptainMarvel extends StatelessWidget {
  const CaptainMarvel({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage("assets/pict/Pict-CaptainMarvel.png"),
          fit: BoxFit.cover,
        ),
      ),
    );
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const Text(
            "Captain Marvel is a female superhero from Marvel who has many powers on par with Superman. This superhero named Carol Danvers was originally a space pilot, it...",
            style: TextStyle(
              fontSize: 17,
          ...
          Row(
            ...
            children: const [
              Text(
                "Brie Larson | Samuel L. Jackson | Ben Med...",
                style: TextStyle(
                  fontSize: 17,
                  fontWeight: FontWeight.w400,
                  color: Colors.white,
