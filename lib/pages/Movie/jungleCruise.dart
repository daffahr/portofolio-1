...
class JungleCruise extends StatelessWidget {
  const JungleCruise({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage("assets/pict/Pict-JungleCruise.png"),
          fit: BoxFit.cover,
        ),
      ),
    );
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const Text(
            "Frank (Dwayne Johnson) is a charismatic ship captain. He meets Lily (Emily Blunt), an explorer whose ambition is to find out the truth about a magical tree that has...",
            style: TextStyle(
              fontSize: 17,
          ...
          Row(
            ...
            children: const [
              Text(
                "Dwayne Johnson | Emily Blunt | Edgar...",
                style: TextStyle(
                  fontSize: 17,
                  fontWeight: FontWeight.w400,
                  color: Colors.white,
