...
class BlackWidow extends StatelessWidget {
  const BlackWidow({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage("assets/pict/Pict-BlackWidow.png"),
          fit: BoxFit.cover,
        ),
      ),
    );
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const Text(
            "Marvel Studios Black Widow, Natasha Romanoff aka Black Widow must confront the dark side of her life when a dangerous conspiracy is linked to her past. Pursued by...",
            style: TextStyle(
              fontSize: 17,
          ...
          Row(
            ...
            children: const [
              Text(
                "Scarlett Johansson | Florence Pugh | David...",
                style: TextStyle(
                  fontSize: 17,
                  fontWeight: FontWeight.w400,
                  color: Colors.white,
