...
class Avenger extends StatelessWidget {
  const Avenger({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage("assets/pict/Pict-AvengerEndgame.png"),
          fit: BoxFit.cover,
        ),
      ),
    );
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const Text(
            "Continuing the Avengers Infinity War, which happened after Thanos managed to get all the infinity stones and destroyed 50% of all living things in the universe. Will the Avengers...",
            style: TextStyle(
              fontSize: 17,
          ...
          Row(
            ...
            children: const [
              Text(
                "Robert Downey Jr. | Chris Evans | Chris Hem...",
                style: TextStyle(
                  fontSize: 17,
                  fontWeight: FontWeight.w400,
                  color: Colors.white,
